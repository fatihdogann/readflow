      ...
      <div className="no-print flex flex-col gap-1">
        ...
        <form method="get" action={base} className="flex flex-wrap items-center gap-2">
          <input
            ...
            aria-label="Arama"
            className="min-w-44 flex-1 rounded-md border border-stone-300 bg-white px-3 py-2 text-sm outline-none placeholder:text-stone-500 focus:border-stone-500 dark:border-stone-700 dark:bg-stone-900 dark:placeholder:text-stone-400"
          />
          ...
          <button
            type="submit"
            className="min-h-[36px] rounded-md border border-stone-300 px-3 text-xs font-medium hover:bg-stone-100 dark:border-stone-700 dark:hover:bg-stone-800"
          >
            Filtrele
          </button>
        ...
        <div className="px-1 text-xs text-stone-500 dark:text-stone-400">{visible.length} doküman</div>
      </div>
